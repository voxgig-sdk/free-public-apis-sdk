...
function envOverride(m) {
    if ('TRUE' === process.env.FREE_PUBLIC_APIS_TEST_LIVE ||
        'TRUE' === process.env.FREE_PUBLIC_APIS_TEST_OVERRIDE) {
    ...
    m.FREE_PUBLIC_APIS_TEST_EXPLAIN = process.env.FREE_PUBLIC_APIS_TEST_EXPLAIN || m.FREE_PUBLIC_APIS_TEST_EXPLAIN;
    return m;
}
