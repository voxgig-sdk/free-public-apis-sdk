...
class ApIEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set FREE_PUBLIC_APIS_TEST_AP_I_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def ap_i_basic_setup(extra)
  ...
  entid_env_raw = ENV["FREE_PUBLIC_APIS_TEST_AP_I_ENTID"]
