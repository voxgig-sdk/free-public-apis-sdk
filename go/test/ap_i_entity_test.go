...
import (
	...
	vs "github.com/voxgig-sdk/free-public-apis-sdk/go/utility/struct"
)
...
func ap_iBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("FREE_PUBLIC_APIS_TEST_AP_I_ENTID")
	...
	idmapResolved := core.ToMapAny(env["FREE_PUBLIC_APIS_TEST_AP_I_ENTID"])
