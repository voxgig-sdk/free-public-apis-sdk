...
## Install
```bash
go get github.com/voxgig-sdk/free-public-apis-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/free-public-apis-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/free-public-apis-sdk/go=../free-public-apis-sdk/go
```
...
```
github.com/voxgig-sdk/free-public-apis-sdk/go/
├── free-public-apis.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/free-public-apis-sdk/go`) re-exports everything needed
