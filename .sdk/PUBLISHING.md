...
|---|---|---|
| `ts/` | @voxgig-sdk/free-public-apis-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/free-public-apis-sdk \
      --repository voxgig-sdk/free-public-apis-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/free-public-apis-sdk` shows it, and
`npm trust revoke @voxgig-sdk/free-public-apis-sdk --id=<id>` removes it.
