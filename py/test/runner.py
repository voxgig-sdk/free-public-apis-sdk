...
class FreePublicApisTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreePublicApisTestRunner.getenv("FREE_PUBLIC_APIS_TEST_LIVE")
        override = FreePublicApisTestRunner.getenv("FREE_PUBLIC_APIS_TEST_OVERRIDE")
        ...
        explain = FreePublicApisTestRunner.getenv("FREE_PUBLIC_APIS_TEST_EXPLAIN")
